...
function opstore_scripts() {
    ...
    if(!class_exists('Wpop_El_Addons')){
        wp_enqueue_style('slick',OPSTORE_CSS. 'slick.css');
        wp_enqueue_style('slick-theme',OPSTORE_CSS. 'slick-theme.css');
    }
	...
	wp_enqueue_style( 'opstore-style', get_stylesheet_uri() );
    wp_enqueue_style('opstore-responsive',OPSTORE_CSS. 'responsive.css');
    ...
    if(!class_exists('Wpop_El_Addons')){
        wp_enqueue_script( 'slick', OPSTORE_JS . 'slick.min.js', array('jquery'), OPSTORE_VERSION, true );
    }
    if(class_exists('Wpop_El_Addons')){
        wp_enqueue_script( 'jquery-countdown', OPSTORE_JS . 'jquery.countdown.min.js', array('jquery'), OPSTORE_VERSION, true );
        wp_enqueue_script( 'isotope', OPSTORE_JS . 'isotope/isotope.pkgd.js', array('jquery'), OPSTORE_VERSION, true );
        wp_enqueue_script( 'packery', OPSTORE_JS . 'isotope/packery-mode.pkgd.js', array('jquery'), OPSTORE_VERSION, true );
    }
...
//admin scripts
function opstore_admin_scripts() {
