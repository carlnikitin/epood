...
if ( !function_exists( 'saleszone_brand_sidebar_image' ) ) {
    ...
    function saleszone_brand_sidebar_image()
    {
        ...
        if ( is_tax( 'product_brand' ) ) {
            ...
            $imageURL = wp_get_attachment_image_url( get_term_meta( $brand->term_id, 'thumbnail_id', true ), 'thumbnail' );
...
if ( !function_exists( 'saleszone_get_social_share_links' ) ) {
    ...
    {
        return apply_filters( 'saleszone_social_share_links', array(
            ...
            'pinterest'   => 'https://pinterest.com/pin/create/button/?url=' . get_permalink() . '&amp;media=' . get_permalink() . '&amp;description=' . get_the_title(),
...
if ( !function_exists( 'saleszone_render_wishlist_catalog_button' ) ) {
    function saleszone_render_wishlist_catalog_button()
    {
        ...
        if ( function_exists( 'premmerce_wishlist' ) ) {
            ...
            ?>
            <div class="pc-product-action" data-ajax-inject="wishlist-link--<?php 
        ...
        if ( function_exists( 'premmerce_wishlist' ) ) {
            ...
            <div class="product-snippet__action-item">
                <div class="pc-product-action"
                     data-ajax-inject="wishlist-link--<?php 
            echo  esc_attr( $productId ) ;
            ?>"> <?php 
            wc_get_template( '../premmerce-woocommerce-wishlist/wishlist-btn.php', array(
                'type'      => 'link',
...
if ( !function_exists( 'saleszone_render_saleszone_active_filters_widget' ) ) {
    function saleszone_render_saleszone_active_filters_widget()
    {
