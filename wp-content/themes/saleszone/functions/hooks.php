 ...
 * Archive sidebar
 */
add_action( 'premmerce-archive-products-container-end', 'saleszone_render_archive_products_description' );
add_action( 'premmerce-archive-products-layout-body-after-header', 'saleszone_render_saleszone_active_filters_widget' );
/**
...
if ( isset( $premmerce_comparison_frontend ) ) {
    ...
    remove_action( 'woocommerce_after_shop_loop_item', array( $premmerce_comparison_frontend, 'renderComparisonBtn' ) );
...
if ( isset( $premmerce_advanced_attributes_frontend ) ) {
    ...
    remove_action( 'saleszone_render_main_loop_attributes', array( $premmerce_advanced_attributes_frontend, 'renderLoopMainAttributes' ) );
}
