...
function dc_valentines_heart() {
	...
	var heartcolor=new Array("#c6041b", "#e10027", "#E1001c", "#C10227", "#Ea002d", "#ed1c38", "#3f7bf3", "#ffe600")
	// Set the fonts, that create the heartflakes. Add as many fonts as you like
	var hearttype=new Array("Times","Arial","Times","Verdana", "Impact", "Charcoal, sans-serif")
